...
const OurMission = () => {
    return (
        <>
            <section className='pt-20 sm:pt-24 md:pt-[126px] lg:pt-[223px] max-w-[1531px] mx-auto relative'>
                <div className='max-w-[1115px] xxl:max-w-[1280px] w-full mx-auto px-6 relative z-20'>
