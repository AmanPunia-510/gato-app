...
const CatCafe = () => {
    return (
        <>
            <section className='pt-20 sm:pt-24 md:pt-[126px] lg:pt-[227px] w-full max-w-[1531px] mx-auto relative'>
                ...
                <img src={Cat_Cafe_ellips} className='absolute right-0 top-[165px] -z-0 max-md:hidden' alt="Cat_Cafe_ellips" />
            </section>
        </>
    )
}
