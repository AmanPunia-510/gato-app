    ...
    return (
        <>
            <section className='pt-[257px] relative  max-w-[1920px] mx-auto'>
                ...
                <img src={ellips} className='max-w-[192px] absolute top-[44px] left-0' alt="ellips" />
            </section>
        </>
    )
}

export default Cafe_Gato