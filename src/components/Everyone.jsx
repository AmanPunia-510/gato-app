            ...
            <div className="container">
                ...
                <div className='flex flex-wrap flex-row mx-auto w-full'>
                    <div className='w-full md:w-1/2 xl:w-1/4 px-2 pl-0'>
                        <div className='px-3 py-6 border-[2px] border-solid border-primary shadow-cate_cafe rounded-base h-full hover:shadow-secondary hover:border-secondary cursor-pointer transition-all rounded-[6.67px]'>
