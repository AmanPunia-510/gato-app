...
import About_Bg from '../assets/images/png/About_bg.png'

const About = () => {
    return (
        <>
            <section className='pt-24 md:pt-[126px] lg:pt-[227px] max-w-[1531px] mx-auto'>
                <div className="container xxl:max-w-[1280px]">
                    <div className='flex flex-row flex-wrap mx-auto w-full items-center max-lg:gap-7'>
                        <div className="w-full lg:w-1/2 pr-3">
                            <h2 className='font-norwester font-normal max-lg:text-center text-6xl lg:text-12xl leading-130 text-primary pb-2 sm:pb-5'>ABOUT US</h2>
